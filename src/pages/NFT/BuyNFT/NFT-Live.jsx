      ...
      {byNFT.map((item, index) => (
        ...
        >
          ...
          >
            ...
            >
              <div className="text-xl capitalize font-medium">{item.title}</div>
              <TiLink size={20} />
            </a>
          </div>
